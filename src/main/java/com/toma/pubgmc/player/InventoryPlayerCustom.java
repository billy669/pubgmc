...
public class InventoryPlayerCustom extends InventoryPlayer implements IInventory
{
    ...
    public final NonNullList<ItemStack> additionalSlots = NonNullList.<ItemStack>withSize(3, ItemStack.EMPTY);
    ...
    {
    	super(playerIn);
        this.allInventories = Arrays.<NonNullList<ItemStack>>asList(this.mainInventory, this.armorInventory, this.offHandInventory, this.additionalSlots);
    ...
    public NBTTagList writeToNBT(NBTTagList nbtTagListIn)
    {
        ...
        for (int k = 0; k < this.additionalSlots.size(); ++k)
        {
            if (!((ItemStack)this.additionalSlots.get(k)).isEmpty())
            {
                NBTTagCompound nbttagcompound2 = new NBTTagCompound();
                nbttagcompound2.setByte("Slot", (byte)(k + 200));
                ((ItemStack)this.additionalSlots.get(k)).writeToNBT(nbttagcompound2);
                nbtTagListIn.appendTag(nbttagcompound2);
            }
        }
    ...
    public void readFromNBT(NBTTagList nbtTagListIn)
    {
        ...
        for (int i = 0; i < nbtTagListIn.tagCount(); ++i)
        {
            ...
            if (!itemstack.isEmpty())
            {
                ...
                else if(j >= 200 && j < this.additionalSlots.size() + 200)
                {
                	this.additionalSlots.set(j - 200, itemstack);
                }
            }
        }
    }
    ...
    {
        return this.mainInventory.size() + this.armorInventory.size() + this.offHandInventory.size() + this.additionalSlots.size();
    }
    ...
    public boolean isEmpty()
    {
        ...
        for(ItemStack itemstack3 : this.additionalSlots)
        {
    ...
    public void copyInventory(InventoryPlayerCustom playerInventory)
    {
