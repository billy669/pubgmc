...
public class ModelSolidR extends BlockBase implements IHasModel 
{
	
	private static PropertyDirection FACING = BlockHorizontal.FACING;
	
	public ModelSolidR(String name, Material material, SoundType sound, MapColor color)
	{
